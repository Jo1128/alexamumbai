...
response.titleText = "Update For Mumbai Weather";
  ...
  weather1.find({search: 'Mumbai, Maharashtra', degreeType: 'F'}, function(err, result) {
    if(err) {
    ...
    response.redirectionUrl = "http://jyothimoily.xyz";
    response.mainText = "Hello from weather. Todays weather in Mumbai is expected to be " + day0weather + ".Tomorrows weather will be " +day1weather + ".third day weather will be " + day2weather + " . fourth day weather will be " + day3weather + "fifth day weather will be " + day4weather;
    res.json(response);
    }
